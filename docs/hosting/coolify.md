...
7. Update `Build Pack` to be `Docker Compose`
...
8. Update your domain in `Domains for server`:
...
11. Click deploy and wait for your app to be ready! You'll be able to access it once Coolify says it's "Healthy" at the domain you set up earlier.
